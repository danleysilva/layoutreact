    ...
    return(
        <View>
           ...
           {/* <Text style={styles.numberIntervalo}>{props.ResultIntervalo}</Text> */}
            ...
            <Text>A sua média é: {props.ResultIntervalo} e está no intervalo entre 0 e 10</Text>
    ) : props.ResultIntervalo > 10 && props.ResultIntervalo <=20  ? (
            <Text>A sua média é: {props.ResultIntervalo} e está no intervalo entre 10 e 20</Text>
    ) : props.ResultIntervalo > 20  && props.ResultIntervalo <=30? (
            <Text>A sua média é: {props.ResultIntervalo} e está no intervalo entre 20 e 30</Text>
    ) : props.ResultIntervalo > 30 ? (
        <Text>Sua média é: {props.ResultIntervalo} - Sua média está acima do limite</Text>
) :( 
            <Text ></Text>
    )}
